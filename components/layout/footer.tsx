...
export function Footer() {
  ...
  return (
    <footer className="relative mt-16 border-t border-sky/20 footer-stripes-teal py-14 shadow-2xl text-white">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          {/* Product */}
          <div>
            <h4 className="font-extrabold mb-4 text-white">Produk</h4>
          ...
          {/* Support */}
          <div>
            <h4 className="font-extrabold mb-4 text-white">Bantuan</h4>
            <ul className="space-y-2">
          ...
          {/* Legal */}
          <div>
            <h4 className="font-extrabold mb-4 text-white">Legal</h4>
            <ul className="space-y-2">

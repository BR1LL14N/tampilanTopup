            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Card className="rounded-[24px] border-sky/30 shadow-sky-soft bg-[#183644]/90 backdrop-blur-md">
                <CardContent className="p-6 space-y-4">
                  <div className="h-10 w-10 rounded-xl bg-sky/20 border border-sky/30 text-sky grid place-items-center">
                    <MessageCircle className="h-5 w-5" />
                  </div>
                  <h3 className="font-extrabold text-sm text-white uppercase">Hubungi Via WhatsApp</h3>
              ...
              <Card className="rounded-[24px] border-sky/30 shadow-sky-soft bg-[#183644]/90 backdrop-blur-md">
                <CardContent className="p-6 space-y-4">
                  ...
                  <h3 className="font-extrabold text-sm text-white uppercase">Cek Status Transaksi</h3>
                  <p className="text-xs text-white/80 leading-relaxed">
            ...
            <Card className="rounded-[24px] border-sky/30 shadow-sky-soft bg-[#183644]/90 backdrop-blur-md">
              <CardContent className="p-8 space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="font-extrabold text-sm uppercase text-white">Panduan Penting Sebelum Mengajukan Komplain</h3>
                </div>
                <ul className="list-disc list-inside text-xs text-white/80 space-y-2 leading-relaxed">

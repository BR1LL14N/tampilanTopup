...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Mitsuru - Top Up Game Murah & Cepat 24/7",
    description:
      "Top up game favorit kamu dengan harga termurah, aman, dan proses instan otomatis 24 jam.",
    images: ["/logo.png"],
  },
  robots: {
    index: true,
...
export default function RootLayout({
  ...
  return (
    <html lang="id" suppressHydrationWarning>
      ...
      <body
        className={`${montserrat.variable} ${poppins.variable} min-h-screen antialiased font-body`}
      >
        <PWARegister />
        <DynamicFavicon />
        <div className="relative min-h-screen flex flex-col bg-[#1c4759]">
          {/* Lightweight High-Performance Grid Pattern */}
          <div

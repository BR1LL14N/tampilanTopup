          ...
          <Card className="rounded-[24px] border-sky/30 shadow-sky-soft bg-[#183644]/90 backdrop-blur-md">
            <CardContent className="p-8 space-y-6 text-sm text-white/80 leading-relaxed">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="font-extrabold text-base uppercase text-white">Syarat Pengembalian Dana</h2>
              </div>
              
              <div className="space-y-4">
                <h3 className="font-extrabold text-xs uppercase text-white">1. Transaksi Selesai Bersifat Final</h3>
                <p className="text-xs">
                ...
                <h3 className="font-extrabold text-xs uppercase text-white">2. Refund Atas Kesalahan Sistem</h3>
                <p className="text-xs">
                ...
                <h3 className="font-extrabold text-xs uppercase text-white">3. Kesalahan ID Akun Pelanggan</h3>
                <p className="text-xs">
                ...
                <h3 className="font-extrabold text-xs uppercase text-white">4. Waktu Proses Refund</h3>
                <p className="text-xs">

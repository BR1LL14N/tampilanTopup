            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Card className="rounded-[24px] border-sky/30 shadow-sky-soft bg-[#183644]/90 backdrop-blur-md">
                <CardContent className="p-6 text-center">
                  <div className="h-12 w-12 rounded-2xl bg-sky/20 border border-sky/30 text-sky grid place-items-center mx-auto mb-4">
                    <PiggyBank className="h-6 w-6" />
                  </div>
                  <h3 className="font-extrabold text-xs uppercase text-white mb-2">Harga Distributor</h3>
              ...
              <Card className="rounded-[24px] border-sky/30 shadow-sky-soft bg-[#183644]/90 backdrop-blur-md">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="font-extrabold text-xs uppercase text-white mb-2">Diskon Promo</h3>
                  <p className="text-[11px] text-white/80 leading-relaxed">
              ...
              <Card className="rounded-[24px] border-sky/30 shadow-sky-soft bg-[#183644]/90 backdrop-blur-md">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="font-extrabold text-xs uppercase text-white mb-2">Bebas PPN Tambahan</h3>
                  <p className="text-[11px] text-white/80 leading-relaxed">

            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Card className="rounded-[24px] border-sky/30 shadow-sky-soft bg-[#183644]/90 backdrop-blur-md">
                <CardContent className="p-6 flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-extrabold text-sm text-white uppercase mb-1">Proses Instan 24/7</h3>
              ...
              <Card className="rounded-[24px] border-sky/30 shadow-sky-soft bg-[#183644]/90 backdrop-blur-md">
                <CardContent className="p-6 flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-extrabold text-sm text-white uppercase mb-1">Keamanan Terjamin</h3>
                    <p className="text-xs text-white/80 leading-relaxed">
              ...
              <Card className="rounded-[24px] border-sky/30 shadow-sky-soft bg-[#183644]/90 backdrop-blur-md">
                <CardContent className="p-6 flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-extrabold text-sm text-white uppercase mb-1">Harga Termurah</h3>
                    <p className="text-xs text-white/80 leading-relaxed">
              ...
              <Card className="rounded-[24px] border-sky/30 shadow-sky-soft bg-[#183644]/90 backdrop-blur-md">
                <CardContent className="p-6 flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-extrabold text-sm text-white uppercase mb-1">Resmi &amp; Legal</h3>
                    <p className="text-xs text-white/80 leading-relaxed">
